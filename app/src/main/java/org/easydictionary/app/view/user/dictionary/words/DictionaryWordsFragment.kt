...
import org.easydictionary.app.view.user.dictionary.SwipeDictionaryItem
...
import org.easydictionary.app.view.widget.OnItemSwipedListener
...
class DictionaryWordsFragment : AbstractBaseFragment() {
    ...
    companion object {
        ...
        const val BUNDLE_DICTIONARY_ID =
            "org.easydictionary.app.view.user.dictionary.words.DictionaryWordsFragment.BUNDLE_DICTIONARY_ID"
