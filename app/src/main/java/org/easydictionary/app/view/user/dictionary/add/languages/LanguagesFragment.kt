package org.easydictionary.app.view.user.dictionary.add.languages
...
class LanguagesFragment : Fragment() {
    ...
    companion object {
        const val BUNDLE_LANGUAGE_SELECT_RESULT =
            "org.easydictionary.app.view.user.dictionary.add.languages.LanguagesFragment.BUNDLE_LANGUAGE_SELECT_RESULT"
        const val BUNDLE_LANGUAGE_SELECT_KEY =
            "org.easydictionary.app.view.user.dictionary.add.languages.LanguagesFragment.BUNDLE_LANGUAGE_SELECT_KEY"
        const val BUNDLE_LANGUAGE_TYPE_KEY =
            "org.easydictionary.app.view.user.dictionary.add.languages.LanguagesFragment.BUNDLE_LANGUAGE_TYPE_KEY"
    }
