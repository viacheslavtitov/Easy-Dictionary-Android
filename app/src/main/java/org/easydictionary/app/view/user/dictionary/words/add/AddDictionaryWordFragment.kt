package org.easydictionary.app.view.user.dictionary.words.add
...
import org.easydictionary.app.view.ext.addMenuProvider
import org.easydictionary.app.view.ext.hideKeyboard
import org.easydictionary.app.view.user.dictionary.words.tags.AddWordTagsFragment
import org.easydictionary.app.view.widget.bubble.BubbleLayout
import org.easydictionary.app.view.widget.bubble.BubbleView
import org.easydictionary.app.view.widget.phonetic.OnPhoneticClickListener
...
class AddDictionaryWordFragment : AbstractBaseFragment() {
    ...
    companion object {
        ...
        const val BUNDLE_DICTIONARY_ID =
            "org.easydictionary.app.view.user.dictionary.words.add.AddDictionaryWordFragment.BUNDLE_DICTIONARY_ID"
        const val BUNDLE_TRANSLATION_VARIANT =
            "org.easydictionary.app.view.user.dictionary.words.add.AddDictionaryWordFragment.BUNDLE_TRANSLATION_VARIANT"
        const val BUNDLE_TRANSLATION_VARIANT_CATEGORY =
            "org.easydictionary.app.view.user.dictionary.words.add.AddDictionaryWordFragment.BUNDLE_TRANSLATION_VARIANT_CATEGORY"
        const val BUNDLE_TRANSLATION_VARIANT_RESULT =
            "org.easydictionary.app.view.user.dictionary.words.add.AddDictionaryWordFragment.BUNDLE_TRANSLATION_VARIANT_RESULT"
        const val BUNDLE_WORD =
            "org.easydictionary.app.view.user.dictionary.words.add.AddDictionaryWordFragment.BUNDLE_WORD"
